...
@scenario('../features/application_lb_network_unavailable_usual_case.feature',
          'Execute SSM automation document Digito-ForceApplicationLbNetworkUnavailableTest_2020-04-01 usual case')
def test_application_lb_network_unavailable_usual_case():
    pass


@scenario('../features/application_lb_network_unavailable_usual_case.feature',
          'Execute SSM automation document Digito-ForceApplicationLbNetworkUnavailableTest_2020-04-01 with '
...
@scenario('../features/application_lb_network_unavailable_rollback_previous.feature',
          'Execute SSM automation document Digito-ForceApplicationLbNetworkUnavailableTest_2020-04-01 in rollback')
...
@scenario('../features/application_lb_network_unavailable_failed.feature',
          'Execute SSM automation document Digito-ForceApplicationLbNetworkUnavailableTest_2020-04-01 to test failure '
          'case')
...
@scenario('../features/application_lb_network_unavailable_failed.feature',
          'Execute SSM automation document Digito-ForceApplicationLbNetworkUnavailableTest_2020-04-01 '
