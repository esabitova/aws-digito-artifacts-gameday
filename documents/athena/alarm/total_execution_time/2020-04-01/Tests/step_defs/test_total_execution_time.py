...
def test_total_execution_time_alarm_green():
    """
...
@scenario('../features/total_execution_time.feature',
          'Create athena:alarm:total_execution_time:2020-04-01 based on TotalExecutionTime metric and '
          'check ALARM status')
def test_total_execution_time_alarm_red():
    """
