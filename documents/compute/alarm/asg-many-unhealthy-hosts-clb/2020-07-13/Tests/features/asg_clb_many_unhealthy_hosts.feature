@asg_clb @integration @alarm @many_unhealthy
Feature: Alarm Setup - ASG Many dying hosts CLB
  Scenario: Lease ASG from resource manager and test attach an alarm from Document
    ...
    When alarm "compute:alarm:asg-many-unhealthy-hosts-clb:2020-07-13" is installed
