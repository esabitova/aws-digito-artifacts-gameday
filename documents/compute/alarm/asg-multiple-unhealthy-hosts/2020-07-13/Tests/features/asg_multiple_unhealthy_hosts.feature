@asg @integration @alarm @multiple_unhealthy
Feature: Alarm Setup - ASG Multiple Unhealthy Hosts
  Scenario: Lease ASG from resource manager and test attach an alarm from Document
    ...
    When alarm "compute:alarm:asg-multiple-unhealthy-hosts:2020-07-13" is installed
