...
Feature: Alarm Setup - redshift Cluster_HealthStatus
  Scenario: Lease redshift from resource manager and test attach an alarm from Document
    ...
    When alarm "redshift:alarm:cluster_health_status:2020-04-01" is installed
      ...
      | under_test | {{cfn-output:RedshiftTemplate>ClusterName}} | 1         | 5                 | 3                 | {{cfn-output:SnsForAlarms>Topic}} |
