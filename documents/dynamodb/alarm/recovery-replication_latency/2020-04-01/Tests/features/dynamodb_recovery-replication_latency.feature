...
Feature: Alarm Setup - dynamodb ReplicationLatency
  Scenario: Replication Latency - red
    ...
    And enabled global dynamodb table {{cfn-output:DynamoDBTemplate>DynamoDBTable}} in the region {{cache:before>GlobalTableSecondaryRegion}} and wait for 600 seconds with delay 20 seconds
