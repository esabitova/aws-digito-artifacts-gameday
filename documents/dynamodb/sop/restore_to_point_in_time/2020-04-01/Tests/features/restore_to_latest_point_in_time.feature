...
Feature: SSM automation document to restore the database from point in time.
  ...
  Scenario: Restores table to the latest available point
    ...
    And published "Digito-RestoreDynamoDBTableToPointInTimeSOP_2020-04-01" SSM document
    ...
    When SSM automation document "Digito-RestoreDynamoDBTableToPointInTimeSOP_2020-04-01" executed
      | DynamoDBTableSourceName                       | DynamoDBTableTargetName            | AutomationAssumeRole                                                                               |
      | {{cfn-output:DynamoDBTemplate>DynamoDBTable}} | {{cache:TargetTableToRestoreName}} | {{cfn-output:AutomationAssumeRoleTemplate>DigitoRestoreDynamoDBTableFromPointInTimeSOPAssumeRole}} |
    Then SSM automation document "Digito-RestoreDynamoDBTableToPointInTimeSOP_2020-04-01" execution in status "Success"
      | ExecutionId                |
  ...
  Scenario: Restores table to the latest available point. With GlobalTable
    ...
    And enabled global dynamodb table {{cfn-output:DynamoDBTemplate>DynamoDBTable}} in the region {{cache:GlobalTableSecondaryRegion}} and wait for 3600 seconds with delay 20 seconds
    And wait table {{cfn-output:DynamoDBTemplate>DynamoDBTable}} to be active for 300 seconds with interval 20 seconds
    When SSM automation document "Digito-RestoreDynamoDBTableToPointInTimeSOP_2020-04-01" executed
      | DynamoDBTableSourceName                       | DynamoDBTableTargetName            | AutomationAssumeRole                                                                               |
      | {{cfn-output:DynamoDBTemplate>DynamoDBTable}} | {{cache:TargetTableToRestoreName}} | {{cfn-output:AutomationAssumeRoleTemplate>DigitoRestoreDynamoDBTableFromPointInTimeSOPAssumeRole}} |
  ...
  Scenario: Restores table to the latest available point. With Scaling
    ...
    When SSM automation document "Digito-RestoreDynamoDBTableToPointInTimeSOP_2020-04-01" executed
      | DynamoDBTableSourceName                                      | DynamoDBTableTargetName            | AutomationAssumeRole                                                                               |
      | {{cfn-output:DynamoDBTemplateWithAutoScaling>DynamoDBTable}} | {{cache:TargetTableToRestoreName}} | {{cfn-output:AutomationAssumeRoleTemplate>DigitoRestoreDynamoDBTableFromPointInTimeSOPAssumeRole}} |
    Then SSM automation document "Digito-RestoreDynamoDBTableToPointInTimeSOP_2020-04-01" execution in status "Success"
      | ExecutionId                |
      | {{cache:SsmExecutionId>1}} |
  ...
  Scenario: Restores table to the latest available point. Copy Alarms
    ...
    When SSM automation document "Digito-RestoreDynamoDBTableToPointInTimeSOP_2020-04-01" executed
      ...
      | {{cfn-output:DynamoDBTemplate>DynamoDBTable}} | {{cache:TargetTableToRestoreName}} | {{cfn-output:AutomationAssumeRoleTemplate>DigitoRestoreDynamoDBTableFromPointInTimeSOPAssumeRole}} | {{cfn-output:DynamoDBTemplate>WriteThrottleEventsAlarmName}} |
    Then SSM automation document "Digito-RestoreDynamoDBTableToPointInTimeSOP_2020-04-01" execution in status "Success"
      | ExecutionId                |
      | {{cache:SsmExecutionId>1}} |
  ...
  Scenario: Restores table to the latest available point. With Indexes
    ...
    When SSM automation document "Digito-RestoreDynamoDBTableToPointInTimeSOP_2020-04-01" executed
      | DynamoDBTableSourceName                                | DynamoDBTableTargetName            | AutomationAssumeRole                                                                               |
      | {{cfn-output:DynamoDBTemplateWithIndex>DynamoDBTable}} | {{cache:TargetTableToRestoreName}} | {{cfn-output:AutomationAssumeRoleTemplate>DigitoRestoreDynamoDBTableFromPointInTimeSOPAssumeRole}} |
    Then SSM automation document "Digito-RestoreDynamoDBTableToPointInTimeSOP_2020-04-01" execution in status "Success"
      | ExecutionId                |
      | {{cache:SsmExecutionId>1}} |
  ...
  Scenario: Restores table to the latest available point. With Indexes and contributor insights enabled
    ...
    When SSM automation document "Digito-RestoreDynamoDBTableToPointInTimeSOP_2020-04-01" executed
      | DynamoDBTableSourceName                                                      | DynamoDBTableTargetName            | AutomationAssumeRole                                                                               |
      | {{cfn-output:DynamoDBTemplateWithIndexAndContributorInsights>DynamoDBTable}} | {{cache:TargetTableToRestoreName}} | {{cfn-output:AutomationAssumeRoleTemplate>DigitoRestoreDynamoDBTableFromPointInTimeSOPAssumeRole}} |
    Then SSM automation document "Digito-RestoreDynamoDBTableToPointInTimeSOP_2020-04-01" execution in status "Success"
      | ExecutionId                |
      | {{cache:SsmExecutionId>1}} |
  ...
  Scenario: Restores table to the latest available point. In the source table the stream is enabled
    ...
    When SSM automation document "Digito-RestoreDynamoDBTableToPointInTimeSOP_2020-04-01" executed
      | DynamoDBTableSourceName                                 | DynamoDBTableTargetName            | AutomationAssumeRole                                                                               |
      | {{cfn-output:DynamoDBTemplateWithStream>DynamoDBTable}} | {{cache:TargetTableToRestoreName}} | {{cfn-output:AutomationAssumeRoleTemplate>DigitoRestoreDynamoDBTableFromPointInTimeSOPAssumeRole}} |
    Then SSM automation document "Digito-RestoreDynamoDBTableToPointInTimeSOP_2020-04-01" execution in status "Success"
      | ExecutionId                |
      | {{cache:SsmExecutionId>1}} |
  ...
  Scenario: Restores table to the latest available point with enabled kinesis streaming destination
    ...
    When SSM automation document "Digito-RestoreDynamoDBTableToPointInTimeSOP_2020-04-01" executed
      | DynamoDBTableSourceName                                  | DynamoDBTableTargetName            | AutomationAssumeRole                                                                               |
      | {{cfn-output:DynamoDBTemplateWithKinesis>DynamoDBTable}} | {{cache:TargetTableToRestoreName}} | {{cfn-output:AutomationAssumeRoleTemplate>DigitoRestoreDynamoDBTableFromPointInTimeSOPAssumeRole}} |
    Then SSM automation document "Digito-RestoreDynamoDBTableToPointInTimeSOP_2020-04-01" execution in status "Success"
      | ExecutionId                |
      | {{cache:SsmExecutionId>1}} |
  ...
  Scenario: Restores table to the latest available point with TTL enabled
    ...
    When SSM automation document "Digito-RestoreDynamoDBTableToPointInTimeSOP_2020-04-01" executed
      | DynamoDBTableSourceName                              | DynamoDBTableTargetName            | AutomationAssumeRole                                                                               |
      | {{cfn-output:DynamoDBTemplateWithTtl>DynamoDBTable}} | {{cache:TargetTableToRestoreName}} | {{cfn-output:AutomationAssumeRoleTemplate>DigitoRestoreDynamoDBTableFromPointInTimeSOPAssumeRole}} |
    Then SSM automation document "Digito-RestoreDynamoDBTableToPointInTimeSOP_2020-04-01" execution in status "Success"
      | ExecutionId                |
      | {{cache:SsmExecutionId>1}} |
