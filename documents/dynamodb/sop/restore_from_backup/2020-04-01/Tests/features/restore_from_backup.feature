...
Feature: SSM automation document to restore the database from a backup.
  ...
  Scenario: Restores table from backup
    ...
    And published "Digito-RestoreDynamoDBTableFromBackupSOP_2020-04-01" SSM document
    ...
    When SSM automation document "Digito-RestoreDynamoDBTableFromBackupSOP_2020-04-01" executed
      | DynamoDBTableSourceName                       | DynamoDBTableTargetName            | DynamoDBSourceTableBackupArn | AutomationAssumeRole                                                                          |
      | {{cfn-output:DynamoDBTemplate>DynamoDBTable}} | {{cache:TargetTableToRestoreName}} | {{cache:BackupArn}}          | {{cfn-output:AutomationAssumeRoleTemplate>DigitoRestoreDynamoDBTableFromBackupSOPAssumeRole}} |
    Then SSM automation document "Digito-RestoreDynamoDBTableFromBackupSOP_2020-04-01" execution in status "Success"
      | ExecutionId                |
  ...
  Scenario: Restores table from backup. Stream Enabled
    ...
    When SSM automation document "Digito-RestoreDynamoDBTableFromBackupSOP_2020-04-01" executed
      | DynamoDBTableSourceName                                 | DynamoDBTableTargetName            | DynamoDBSourceTableBackupArn | AutomationAssumeRole                                                                          |
      | {{cfn-output:DynamoDBTemplateWithStream>DynamoDBTable}} | {{cache:TargetTableToRestoreName}} | {{cache:BackupArn}}          | {{cfn-output:AutomationAssumeRoleTemplate>DigitoRestoreDynamoDBTableFromBackupSOPAssumeRole}} |
    Then SSM automation document "Digito-RestoreDynamoDBTableFromBackupSOP_2020-04-01" execution in status "Success"
      | ExecutionId                |
      | {{cache:SsmExecutionId>1}} |
  ...
  Scenario: Restores table from backup. Kinesis Enabled
    ...
    When SSM automation document "Digito-RestoreDynamoDBTableFromBackupSOP_2020-04-01" executed
      | DynamoDBTableSourceName                                  | DynamoDBTableTargetName            | DynamoDBSourceTableBackupArn | AutomationAssumeRole                                                                          |
      | {{cfn-output:DynamoDBTemplateWithKinesis>DynamoDBTable}} | {{cache:TargetTableToRestoreName}} | {{cache:BackupArn}}          | {{cfn-output:AutomationAssumeRoleTemplate>DigitoRestoreDynamoDBTableFromBackupSOPAssumeRole}} |
    Then SSM automation document "Digito-RestoreDynamoDBTableFromBackupSOP_2020-04-01" execution in status "Success"
      | ExecutionId                |
      | {{cache:SsmExecutionId>1}} |
  ...
  Scenario: Restores table from backup. Contributor Insights
    ...
    When SSM automation document "Digito-RestoreDynamoDBTableFromBackupSOP_2020-04-01" executed
      | DynamoDBTableSourceName                                                      | DynamoDBTableTargetName            | DynamoDBSourceTableBackupArn | AutomationAssumeRole                                                                          |
      | {{cfn-output:DynamoDBTemplateWithIndexAndContributorInsights>DynamoDBTable}} | {{cache:TargetTableToRestoreName}} | {{cache:BackupArn}}          | {{cfn-output:AutomationAssumeRoleTemplate>DigitoRestoreDynamoDBTableFromBackupSOPAssumeRole}} |
    Then SSM automation document "Digito-RestoreDynamoDBTableFromBackupSOP_2020-04-01" execution in status "Success"
      | ExecutionId                |
      | {{cache:SsmExecutionId>1}} |
  ...
  Scenario: Restores table from backup. With Autoscaling
    ...
    When SSM automation document "Digito-RestoreDynamoDBTableFromBackupSOP_2020-04-01" executed
      | DynamoDBTableSourceName                                      | DynamoDBTableTargetName            | DynamoDBSourceTableBackupArn | AutomationAssumeRole                                                                          |
      | {{cfn-output:DynamoDBTemplateWithAutoScaling>DynamoDBTable}} | {{cache:TargetTableToRestoreName}} | {{cache:BackupArn}}          | {{cfn-output:AutomationAssumeRoleTemplate>DigitoRestoreDynamoDBTableFromBackupSOPAssumeRole}} |
    Then SSM automation document "Digito-RestoreDynamoDBTableFromBackupSOP_2020-04-01" execution in status "Success"
      | ExecutionId                |
      | {{cache:SsmExecutionId>1}} |
  ...
  Scenario: Restores table from backup with TTL enabled
    ...
    When SSM automation document "Digito-RestoreDynamoDBTableFromBackupSOP_2020-04-01" executed
      | DynamoDBTableSourceName                              | DynamoDBTableTargetName            | DynamoDBSourceTableBackupArn | AutomationAssumeRole                                                                          |
      | {{cfn-output:DynamoDBTemplateWithTtl>DynamoDBTable}} | {{cache:TargetTableToRestoreName}} | {{cache:BackupArn}}          | {{cfn-output:AutomationAssumeRoleTemplate>DigitoRestoreDynamoDBTableFromBackupSOPAssumeRole}} |
    Then SSM automation document "Digito-RestoreDynamoDBTableFromBackupSOP_2020-04-01" execution in status "Success"
      | ExecutionId                |
      | {{cache:SsmExecutionId>1}} |
  ...
  Scenario: Restores table to the latest available point. Copy Alarms
    ...
    When SSM automation document "Digito-RestoreDynamoDBTableFromBackupSOP_2020-04-01" executed
      ...
      | {{cfn-output:DynamoDBTemplate>DynamoDBTable}} | {{cache:TargetTableToRestoreName}} | {{cache:BackupArn}}          | {{cfn-output:AutomationAssumeRoleTemplate>DigitoRestoreDynamoDBTableFromBackupSOPAssumeRole}} | {{cfn-output:DynamoDBTemplate>WriteThrottleEventsAlarmName}} |
    Then SSM automation document "Digito-RestoreDynamoDBTableFromBackupSOP_2020-04-01" execution in status "Success"
      | ExecutionId                |
      | {{cache:SsmExecutionId>1}} |
