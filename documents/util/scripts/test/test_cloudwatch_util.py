...
import time
import pytest
from src.cloudwatch_util import *
...
class TestCloudWatchUtil(unittest.TestCase):
    ...
    def test_verify_ec2_stress_low_cpu_failed(self):
        ...
        self.cw_mock.get_metric_statistics.return_value = {
                    'Datapoints': [{'Maximum': actual_cpu_load}, {'Maximum': '3'}, {'Maximum': '8'}]}
    ...
    def test_verify_ec2_stress_metric_wait_time_success(self):
        expected_cpu_load = 95
        actual_cpu_load = '95'
        self.cw_mock.get_metric_statistics.return_value = {
                'Datapoints': [{'Maximum': actual_cpu_load}, {'Maximum': '3'}, {'Maximum': '8'}]}
        ...
        verify_ec2_stress(instance_ids, stress_duration, expected_cpu_load, metric_delay_secs, 'CPUUtilization', exp_recovery_time)
        end_time = time.time()
    ...
    def test_get_ec2_cpu_metric_max_datapoint_success(self):
        self.cw_mock.get_metric_statistics.return_value = {'Datapoints':[{'Maximum':'10'},{'Maximum':'5'},{'Maximum':'100'},{'Maximum':'7'}]}
