...
Feature: Alarm Setup - Kinesis Analytics Errors
  Scenario: Create kinesis:alarm:data_analytics_kpus:2020-04-01 based on KPUs metric for SQL application and check OK status
    ...
    When alarm "kinesis-analytics:alarm:recovery-kpus:2020-04-01" is installed
      | alarmId    | KinesisAnalyticsAppName                                                                  | Threshold | SNSTopicARN                       | EvaluationPeriods | DatapointsToAlarm |
      | under_test | {{cfn-output:KinesisAnalyticsTemplateSQL>KinesisAnalyticsApplicationPhysicalResourceId}} |    5      | {{cfn-output:SnsForAlarms>Topic}} |     1             |     1             |
  ...
  Scenario: Create kinesis:alarm:data_analytics_kpus:2020-04-01 based on KPUs metric for Apache Flink application and check OK status
    ...
    When alarm "kinesis-analytics:alarm:recovery-kpus:2020-04-01" is installed
      | alarmId    |  KinesisAnalyticsAppName                                                                    | Threshold | SNSTopicARN                       | EvaluationPeriods | DatapointsToAlarm |
      | under_test |  {{cfn-output:KinesisAnalyticsTemplateFlink>KinesisAnalyticsApplicationPhysicalResourceId}} |    5      | {{cfn-output:SnsForAlarms>Topic}} |     1             |     1             |
