...
Feature: Alarm Setup - Kinesis Analytics Errors
  Scenario: Create kinesis:alarm:data_analytics_inputprocessing_droppedrecords:2020-04-01 based on InputProcessing.DroppedRecords metric and check OK status
    ...
    When alarm "kinesis-analytics:alarm:health-processing_dropped_records:2020-04-01" is installed
