...
Feature: Alarm Setup - Kinesis Analytics Errors
  Scenario: Create kinesis:alarm:data_analytics_heap_memory_utilization:2020-04-01 based on heapMemoryUtilization metric and check OK status
    ...
    And start Kinesis Data Analytics for "Apache Flink" application
      ...
      | {{cfn-output:KinesisAnalyticsTemplateFlink>KinesisAnalyticsApplicationPhysicalResourceId}} |
    When alarm "kinesis-analytics:alarm:recovery-heap_memory_utilization:2020-04-01" is installed
      | alarmId    | KinesisAnalyticsAppName                                                                    | Threshold | SNSTopicARN                       | EvaluationPeriods | DatapointsToAlarm |
      | under_test | {{cfn-output:KinesisAnalyticsTemplateFlink>KinesisAnalyticsApplicationPhysicalResourceId}} |    80     | {{cfn-output:SnsForAlarms>Topic}} |     1             |     1             |
