...
Feature: Alarm Setup - Kinesis Analytics Errors
  Scenario: Create kinesis:alarm:data_analytics_full_restarts:2020-04-01 based on fullRestarts metric and check OK status
    ...
    And start Kinesis Data Analytics for "Apache Flink" application
      ...
      | {{cfn-output:KinesisAnalyticsTemplateFlink>KinesisAnalyticsApplicationPhysicalResourceId}} |
    When alarm "kinesis-analytics:alarm:health-full_restarts:2020-04-01" is installed
