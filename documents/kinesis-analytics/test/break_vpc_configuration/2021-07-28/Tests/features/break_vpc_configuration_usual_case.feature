...
Feature: SSM automation document Digito-BreakKinesisDataAnalyticsVpcConfigurationTest_2021-07-28
  ...
  Scenario: Execute SSM automation document Digito-BreakKinesisDataAnalyticsVpcConfigurationTest_2021-07-28
    ...
    And Wait for the SSM automation document "Digito-BreakKinesisDataAnalyticsVpcConfigurationTest_2021-07-28" execution is on step "RollbackCurrentExecution" in status "Success"
      | ExecutionId                |
    ...
    And SSM automation document "Digito-BreakKinesisDataAnalyticsVpcConfigurationTest_2021-07-28" execution in status "Success"
      | ExecutionId                |
      | {{cache:SsmExecutionId>1}} |
    Then assert "KinesisDataAnalyticsVpcSecurityGroup" at "before" became equal to "KinesisDataAnalyticsVpcSecurityGroup" at "after"
    And assert "CheckIsRollback,AssertAlarmToBeGreenBeforeTest,CheckKinesisDataAnalyticsApplicationVPCStatus,AwaitKinesisDataAnalyticsRunningStatusBeforeBackupCurrentExecution,
                BackupCurrentExecution,CreateDummySecurityGroup,InjectFailure,AwaitApplicationUpdateCompleteAfterInjectFailure,AssertAlarmToBeRed,RollbackCurrentExecution,
