...
Feature: SSM automation document Digito-ScaleECSServiceSOP_2020-04-01
  ...
  Scenario: Execute SSM automation document Digito-ScaleECSServiceSOP_2020-04-01 on Fargate. NewTaskDefinition. NumberOfTasks.
    ...
    When SSM automation document "Digito-ScaleECSServiceSOP_2020-04-01" executed
      ...
      | {{cfn-output:ECSFargateTemplate>ClusterName}} | {{cfn-output:ECSFargateTemplate>ECSService}} | {{cache:before>NewTaskDefinitionArn}}  | 2             | {{cfn-output:AutomationAssumeRoleTemplate>DigitoScaleECSServiceSOPAssumeRole}} |
  ...
  Scenario: Execute SSM automation document Digito-ScaleECSServiceSOP_2020-04-01 on Fargate. NewTaskDefinition. No NumberOfTasks.
    Given the cloud formation templates as integration test resources
      | CfnTemplatePath                                                                       | ResourceType | VPC                      |  PublicSubnetOne                    | PublicSubnetTwo                    |
      | resource_manager/cloud_formation_templates/shared/VPC.yml                             | SHARED       |                          |                                     |                                    |
      | resource_manager/cloud_formation_templates/ECSFargateTemplate.yml                     | ON_DEMAND    | {{cfn-output:VPC>VPCId}} | {{cfn-output:VPC>PublicSubnetOne}}  | {{cfn-output:VPC>PublicSubnetTwo}} |
    ...
    When SSM automation document "Digito-ScaleECSServiceSOP_2020-04-01" executed
      ...
      | {{cfn-output:ECSFargateTemplate>ClusterName}} | {{cfn-output:ECSFargateTemplate>ECSService}} | {{cache:before>NewTaskDefinitionArn}}  | {{cfn-output:AutomationAssumeRoleTemplate>DigitoScaleECSServiceSOPAssumeRole}} |
    Then SSM automation document "Digito-ScaleECSServiceSOP_2020-04-01" execution in status "Success"
      | ExecutionId                |
      | {{cache:SsmExecutionId>1}} |
    And cache number of tasks as "AmountOFTasks" "after" SSM execution
  ...
  Scenario: Execute SSM automation document Digito-ScaleECSServiceSOP_2020-04-01 on Fargate. No NewTaskDefinition. No NumberOfTasks.
    Given the cloud formation templates as integration test resources
      | CfnTemplatePath                                                                       | ResourceType | VPC                      |  PublicSubnetOne                    | PublicSubnetTwo                    |
      | resource_manager/cloud_formation_templates/shared/VPC.yml                             | SHARED       |                          |                                     |                                    |
      | resource_manager/cloud_formation_templates/ECSFargateTemplate.yml                     | ON_DEMAND    | {{cfn-output:VPC>VPCId}} | {{cfn-output:VPC>PublicSubnetOne}}  | {{cfn-output:VPC>PublicSubnetTwo}} |
    ...
    When SSM automation document "Digito-ScaleECSServiceSOP_2020-04-01" executed
      ...
      | {{cfn-output:ECSFargateTemplate>ClusterName}} | {{cfn-output:ECSFargateTemplate>ECSService}}  | {{cfn-output:AutomationAssumeRoleTemplate>DigitoScaleECSServiceSOPAssumeRole}} |
    Then SSM automation document "Digito-ScaleECSServiceSOP_2020-04-01" execution in status "Success"
      | ExecutionId                |
      | {{cache:SsmExecutionId>1}} |
    And cache number of tasks as "AmountOFTasks" "after" SSM execution
  ...
  Scenario: Execute SSM automation document Digito-ScaleECSServiceSOP_2020-04-01 on Fargate. No NewTaskDefinition. NumberOfTasks.
    Given the cloud formation templates as integration test resources
      | CfnTemplatePath                                                                       | ResourceType | VPC                      |  PublicSubnetOne                    | PublicSubnetTwo                    |
      | resource_manager/cloud_formation_templates/shared/VPC.yml                             | SHARED       |                          |                                     |                                    |
      | resource_manager/cloud_formation_templates/ECSFargateTemplate.yml                     | ON_DEMAND    | {{cfn-output:VPC>VPCId}} | {{cfn-output:VPC>PublicSubnetOne}}  | {{cfn-output:VPC>PublicSubnetTwo}} |
    ...
    When SSM automation document "Digito-ScaleECSServiceSOP_2020-04-01" executed
      ...
      | {{cfn-output:ECSFargateTemplate>ClusterName}} | {{cfn-output:ECSFargateTemplate>ECSService}} | 2            | {{cfn-output:AutomationAssumeRoleTemplate>DigitoScaleECSServiceSOPAssumeRole}} |
    Then SSM automation document "Digito-ScaleECSServiceSOP_2020-04-01" execution in status "Success"
      | ExecutionId                |
      | {{cache:SsmExecutionId>1}} |
    And cache number of tasks as "AmountOFTasks" "after" SSM execution
  ...
  Scenario: Execute SSM automation document Digito-ScaleECSServiceSOP_2020-04-01 on Fargate. No NewTaskDefinition. Memory and CPU.
    Given the cloud formation templates as integration test resources
      | CfnTemplatePath                                                                       | ResourceType | VPC                      |  PublicSubnetOne                    | PublicSubnetTwo                    |
      | resource_manager/cloud_formation_templates/shared/VPC.yml                             | SHARED       |                          |                                     |                                    |
      | resource_manager/cloud_formation_templates/ECSFargateTemplate.yml                     | ON_DEMAND    | {{cfn-output:VPC>VPCId}} | {{cfn-output:VPC>PublicSubnetOne}}  | {{cfn-output:VPC>PublicSubnetTwo}} |
    ...
    When SSM automation document "Digito-ScaleECSServiceSOP_2020-04-01" executed
      ...
      | {{cfn-output:ECSFargateTemplate>ClusterName}} | {{cfn-output:ECSFargateTemplate>ECSService}} | 256               | 512               | {{cfn-output:AutomationAssumeRoleTemplate>DigitoScaleECSServiceSOPAssumeRole}} |
    Then SSM automation document "Digito-ScaleECSServiceSOP_2020-04-01" execution in status "Success"
      | ExecutionId                |
      | {{cache:SsmExecutionId>1}} |
