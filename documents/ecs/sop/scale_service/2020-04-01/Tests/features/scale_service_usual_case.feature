...
Feature: SSM automation document Digito-ScaleService_2020-04-01
  ...
  Scenario: Execute SSM automation document Digito-ScaleService_2020-04-01 on EC2. NewTaskDefinition. NumberOfTasks.
    ...
    When SSM automation document "Digito-ScaleService_2020-04-01" executed
      ...
      | {{cfn-output:ECSEC2Template>ClusterName}} | {{cfn-output:ECSEC2Template>ECSService}} | {{cache:before>NewTaskDefinitionArn}}  |  2             | {{cfn-output:AutomationAssumeRoleTemplate>DigitoEcsScaleServiceAssumeRole}} |
  ...
  Scenario: Execute SSM automation document Digito-ScaleService_2020-04-01 on EC2. NewTaskDefinition. No NumberOfTasks.
    Given the cloud formation templates as integration test resources
      | CfnTemplatePath                                                                       | ResourceType | VPC                      |  PublicSubnetOne                    | PublicSubnetTwo                    |
      | resource_manager/cloud_formation_templates/shared/VPC.yml                             | SHARED       |                          |                                     |                                    |
      | resource_manager/cloud_formation_templates/ECSEC2Template.yml                         | ON_DEMAND    | {{cfn-output:VPC>VPCId}} | {{cfn-output:VPC>PublicSubnetOne}}  | {{cfn-output:VPC>PublicSubnetTwo}} |
    ...
    When SSM automation document "Digito-ScaleService_2020-04-01" executed
      ...
      | {{cfn-output:ECSEC2Template>ClusterName}} | {{cfn-output:ECSEC2Template>ECSService}} | {{cache:before>NewTaskDefinitionArn}}  | {{cfn-output:AutomationAssumeRoleTemplate>DigitoEcsScaleServiceAssumeRole}} |
    Then SSM automation document "Digito-ScaleService_2020-04-01" execution in status "Success"
      | ExecutionId                |
      | {{cache:SsmExecutionId>1}} |
    And wait ServicesStable
  ...
  Scenario: Execute SSM automation document Digito-ScaleService_2020-04-01 on EC2. No NewTaskDefinition. No NumberOfTasks.
    Given the cloud formation templates as integration test resources
      | CfnTemplatePath                                                                       | ResourceType | VPC                      |  PublicSubnetOne                    | PublicSubnetTwo                    |
      | resource_manager/cloud_formation_templates/shared/VPC.yml                             | SHARED       |                          |                                     |                                    |
      | resource_manager/cloud_formation_templates/ECSEC2Template.yml                         | ON_DEMAND    | {{cfn-output:VPC>VPCId}} | {{cfn-output:VPC>PublicSubnetOne}}  | {{cfn-output:VPC>PublicSubnetTwo}} |
    ...
    When SSM automation document "Digito-ScaleService_2020-04-01" executed
      ...
      | {{cfn-output:ECSEC2Template>ClusterName}} | {{cfn-output:ECSEC2Template>ECSService}}  | {{cfn-output:AutomationAssumeRoleTemplate>DigitoEcsScaleServiceAssumeRole}} |
    Then SSM automation document "Digito-ScaleService_2020-04-01" execution in status "Success"
      | ExecutionId                |
      | {{cache:SsmExecutionId>1}} |
    And wait ServicesStable
  ...
  Scenario: Execute SSM automation document Digito-ScaleService_2020-04-01 on EC2. No NewTaskDefinition. NumberOfTasks.
    Given the cloud formation templates as integration test resources
      | CfnTemplatePath                                                                       | ResourceType | VPC                      |  PublicSubnetOne                    | PublicSubnetTwo                    |
      | resource_manager/cloud_formation_templates/shared/VPC.yml                             | SHARED       |                          |                                     |                                    |
      | resource_manager/cloud_formation_templates/ECSEC2Template.yml                         | ON_DEMAND    | {{cfn-output:VPC>VPCId}} | {{cfn-output:VPC>PublicSubnetOne}}  | {{cfn-output:VPC>PublicSubnetTwo}} |
    ...
    When SSM automation document "Digito-ScaleService_2020-04-01" executed
      ...
      | {{cfn-output:ECSEC2Template>ClusterName}} | {{cfn-output:ECSEC2Template>ECSService}} |  2            | {{cfn-output:AutomationAssumeRoleTemplate>DigitoEcsScaleServiceAssumeRole}} |
    Then SSM automation document "Digito-ScaleService_2020-04-01" execution in status "Success"
      | ExecutionId                |
      | {{cache:SsmExecutionId>1}} |
    And wait ServicesStable
  ...
  Scenario: Execute SSM automation document Digito-ScaleService_2020-04-01 on EC2. No NewTaskDefinition. Memory and CPU.
    Given the cloud formation templates as integration test resources
      | CfnTemplatePath                                                                       | ResourceType | VPC                      |  PublicSubnetOne                    | PublicSubnetTwo                    |
      | resource_manager/cloud_formation_templates/shared/VPC.yml                             | SHARED       |                          |                                     |                                    |
      | resource_manager/cloud_formation_templates/ECSEC2Template.yml                         | ON_DEMAND    | {{cfn-output:VPC>VPCId}} | {{cfn-output:VPC>PublicSubnetOne}}  | {{cfn-output:VPC>PublicSubnetTwo}} |
    ...
    When SSM automation document "Digito-ScaleService_2020-04-01" executed
      ...
      | {{cfn-output:ECSEC2Template>ClusterName}} | {{cfn-output:ECSEC2Template>ECSService}} | 256               |  512               | {{cfn-output:AutomationAssumeRoleTemplate>DigitoEcsScaleServiceAssumeRole}} |
    Then SSM automation document "Digito-ScaleService_2020-04-01" execution in status "Success"
      | ExecutionId                |
      | {{cache:SsmExecutionId>1}} |
    And wait ServicesStable
