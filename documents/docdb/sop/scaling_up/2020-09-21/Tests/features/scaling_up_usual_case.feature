# @docdb
Feature: SSM automation document Digito-ScaleUpDocumentDBClusterSOP_2020-09-21

  Scenario: Execute SSM automation document Digito-ScaleUpDocumentDBClusterSOP_2020-09-21
