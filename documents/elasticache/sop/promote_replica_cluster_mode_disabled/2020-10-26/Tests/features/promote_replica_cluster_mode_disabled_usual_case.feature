...
Feature: SSM automation document Digito-PromoteReplicaClusterModeDisabled_2020-10-26
  ...
  Scenario: Execute SSM automation document Digito-PromoteReplicaClusterModeDisabled_2020-10-26 with AutomaticFailover disabled in a single AZ deployment
    ...
    When SSM automation document "Digito-PromoteReplicaClusterModeDisabled_2020-10-26" executed
      ...
      | {{cfn-output:ElasticacheReplicationGroupClusterDisabledSingleAZ>ReplicationGroupId}} | {{cache:before>ReplicaClusterId}} | {{cfn-output:AutomationAssumeRoleTemplate>DigitoElasticachePromoteReplicaClusterModeDisabledAssumeRole}} |
  ...
  Scenario: Execute SSM automation document Digito-PromoteReplicaClusterModeDisabled_2020-10-26 with AutomaticFailover enabled in a single AZ deployment
    Given the cloud formation templates as integration test resources
      | CfnTemplatePath                                                                                                       | ResourceType | AutomaticFailoverEnabled |
  ...
  Scenario: Execute SSM automation document Digito-PromoteReplicaClusterModeDisabled_2020-10-26 with AutomaticFailover and MultiAZ enabled in a multi AZ deployment
    Given the cloud formation templates as integration test resources
