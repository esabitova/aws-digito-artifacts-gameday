...
Feature: SSM automation document Digito-RedisDecreaseReplicaCount_2020-10-26
  ...
  Scenario: Execute SSM automation document Digito-RedisDecreaseReplicaCount_2020-10-26 to decrease redis replica count with Desired Replicas specified
    ...
    And published "Digito-RedisDecreaseReplicaCount_2020-10-26" SSM document
    ...
    When SSM automation document "Digito-RedisDecreaseReplicaCount_2020-10-26" executed
      | ReplicationGroupId                                                                    | NewReplicaCount                  | AutomationAssumeRole                                                                             |
      | {{cfn-output:ElasticacheReplicationGroupClusterDisabledSingleAZ>ReplicationGroupId}}  | {{cache:before>NewReplicaCount}} | {{cfn-output:AutomationAssumeRoleTemplate>DigitoElasticacheRedisDecreaseReplicaCountAssumeRole}} |
