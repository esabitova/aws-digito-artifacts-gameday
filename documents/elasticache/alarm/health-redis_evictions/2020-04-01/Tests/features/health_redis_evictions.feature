...
Feature: Alarm Setup - Elasticache Errors
  Scenario: Create elasticache:alarm:health-redis_evictions:2020-04-01 for Redis based on Evictions metric and check OK status
    ...
    When alarm "elasticache:alarm:health-redis_evictions:2020-04-01" is installed
