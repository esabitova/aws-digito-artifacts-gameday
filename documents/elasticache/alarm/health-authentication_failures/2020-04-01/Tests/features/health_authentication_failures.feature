...
Feature: Alarm Setup - Elasticache Errors
  Scenario: Create elasticache:alarm:health-authentication_failures:2020-04-01 based on AuthenticationFailures metric and check OK status
    ...
    When alarm "elasticache:alarm:health-authentication_failures:2020-04-01" is installed
