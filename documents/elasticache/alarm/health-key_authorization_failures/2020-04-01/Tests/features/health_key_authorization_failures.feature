...
Feature: Alarm Setup - Elasticache Errors
  Scenario: Create elasticache:alarm:key_authorization_failures:2020-04-01 based on KeyAuthorizationFailures metric and check OK status
    ...
    When alarm "elasticache:alarm:health-key_authorization_failures:2020-04-01" is installed
