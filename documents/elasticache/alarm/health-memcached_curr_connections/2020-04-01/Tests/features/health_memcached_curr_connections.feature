...
Feature: Alarm Setup - Elasticache Errors
  ...
  Scenario: Create elasticache:alarm:health-memcached_curr_connections:2020-04-01 for Memcached based on CurrConnections metric and check OK status
    Given the cloud formation templates as integration test resources
      | CfnTemplatePath                                                            | ResourceType |
      | resource_manager/cloud_formation_templates/ElasticacheClusterMemcached.yml | ON_DEMAND    |
      | resource_manager/cloud_formation_templates/shared/SnsForAlarms.yml         | SHARED       |
    When alarm "elasticache:alarm:health-memcached_curr_connections:2020-04-01" is installed
