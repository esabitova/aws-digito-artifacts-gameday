...
Feature: SSM automation document Digito-SimulateRestApiGwNetworkUnavailableTest_2020-09-21
  ...
  Scenario: Execute SSM automation document Digito-SimulateRestApiGwNetworkUnavailableTest_2020-09-21 with provided security group
    ...
    And Wait for the SSM automation document "Digito-SimulateRestApiGwNetworkUnavailableTest_2020-09-21" execution is on step "RollbackCurrentExecution" in status "Success"
      | ExecutionId                |
  ...
  Scenario: Execute SSM automation document Digito-SimulateRestApiGwNetworkUnavailableTest_2020-09-21 without provided security group
    Given the cloud formation templates as integration test resources
      | CfnTemplatePath                                                                                          | ResourceType |
      | resource_manager/cloud_formation_templates/RestApiGwPrivateEndpointTemplate.yml                          | ON_DEMAND    |
      | documents/api-gw/test/simulate_network_unavailable/2020-09-21/Documents/AutomationAssumeRoleTemplate.yml | ASSUME_ROLE  |
