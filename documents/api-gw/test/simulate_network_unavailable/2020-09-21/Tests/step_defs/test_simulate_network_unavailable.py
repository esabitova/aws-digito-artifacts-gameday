...
@scenario('../features/simulate_network_unavailable_usual_case.feature',
          'Execute SSM automation document Digito-SimulateRestApiGwNetworkUnavailableTest_2020-09-21 with provided '
          'security group')
def test_simulate_network_unavailable_usual_case_with_provided_security_group():
    """Execute SSM automation document Digito-SimulateRestApiGwNetworkUnavailableTest_2020-09-21"""


@scenario('../features/simulate_network_unavailable_usual_case.feature',
          'Execute SSM automation document Digito-SimulateRestApiGwNetworkUnavailableTest_2020-09-21 without provided '
          'security group')
...
@scenario('../features/simulate_network_unavailable_rollback_previous.feature',
          'Execute SSM automation document Digito-SimulateRestApiGwNetworkUnavailableTest_2020-09-21 in rollback test')
...
@scenario('../features/simulate_network_unavailable_rollback_negative.feature',
          'Execute SSM automation document Digito-SimulateRestApiGwNetworkUnavailableTest_2020-09-21 to test '
...
@scenario('../features/simulate_network_unavailable_failed.feature',
          'Execute SSM automation document Digito-SimulateRestApiGwNetworkUnavailableTest_2020-09-21 to'
