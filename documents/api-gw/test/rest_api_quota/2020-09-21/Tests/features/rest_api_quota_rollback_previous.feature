...
Feature: SSM automation document Digito-RestApiGwQuota_2020-09-21
  ...
  Scenario: Execute SSM automation document Digito-RestApiGwQuota_2020-09-21 in rollback test
    ...
    Then SSM automation document "Digito-RestApiGwQuota_2020-09-21" execution in status "Success"
      | ExecutionId                |
