...
Feature: SSM automation document Digito-TriggerHttpWsApiGwThrottlingTest_2020-09-21
  ...
  Scenario: Execute SSM automation document Digito-TriggerHttpWsApiGwThrottlingTest_2020-09-21 for HTTP API to test failure case
    ...
    And Wait for the SSM automation document "Digito-TriggerHttpWsApiGwThrottlingTest_2020-09-21" execution is on step "RollbackCurrentExecution" in status "Success"
      | ExecutionId                |
    ...
    Then SSM automation document "Digito-TriggerHttpWsApiGwThrottlingTest_2020-09-21" execution in status "TimedOut"
      | ExecutionId                |
      | {{cache:SsmExecutionId>1}} |
