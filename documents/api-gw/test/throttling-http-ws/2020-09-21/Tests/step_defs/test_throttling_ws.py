...
@scenario('../features/throttling_ws_usual_case.feature',
          'Execute SSM automation document Digito-TriggerHttpWsApiGwThrottlingTest_2020-09-21 for WS API')
...
@scenario('../features/throttling_ws_rollback_previous.feature',
          'Execute SSM automation document Digito-TriggerHttpWsApiGwThrottlingTest_2020-09-21 for WS API in rollback')
...
@scenario('../features/throttling_ws_failed.feature',
          'Execute SSM automation document Digito-TriggerHttpWsApiGwThrottlingTest_2020-09-21 for WS API to test '
          'failure case')
