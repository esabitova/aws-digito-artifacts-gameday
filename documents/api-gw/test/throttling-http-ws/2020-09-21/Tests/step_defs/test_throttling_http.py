...
@scenario('../features/throttling_http_usual_case.feature',
          'Execute SSM automation document Digito-ThrottlingHttpWs_2020-09-21 for HTTP API')
...
@scenario('../features/throttling_http_rollback_previous.feature',
          'Execute SSM automation document Digito-ThrottlingHttpWs_2020-09-21 for HTTP API in rollback')
...
@scenario('../features/throttling_http_failed.feature',
          'Execute SSM automation document Digito-ThrottlingHttpWs_2020-09-21 for HTTP API to test failure case')
