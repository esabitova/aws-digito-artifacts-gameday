...
@scenario('../features/throttling_rest_usual_case.feature',
          'Execute SSM automation document Digito-TriggerRestApiGwThrottlingTest_2020-09-21 without stage name '
          'provided')
...
@scenario('../features/throttling_rest_usual_case.feature',
          'Execute SSM automation document Digito-TriggerRestApiGwThrottlingTest_2020-09-21 with stage name provided')
def test_throttling_rest_usual_case_with_stage_name():
    """Execute SSM automation document Digito-ThrottlingRest_2020-09-21"""


@scenario('../features/throttling_rest_rollback_previous.feature',
          'Execute SSM automation document Digito-TriggerRestApiGwThrottlingTest_2020-09-21 in rollback'
...
@scenario('../features/throttling_rest_rollback_negative.feature',
          'Execute SSM automation document Digito-TriggerRestApiGwThrottlingTest_2020-09-21 in negative rollback'
...
@scenario('../features/throttling_rest_failed.feature',
          'Execute SSM automation document Digito-TriggerRestApiGwThrottlingTest_2020-09-21 in failed'
