...
Feature: SSM automation document Digito-TriggerRestApiGwThrottlingTest_2020-09-21
  ...
  Scenario: Execute SSM automation document Digito-TriggerRestApiGwThrottlingTest_2020-09-21 without stage name provided
    ...
    And SSM automation document "Digito-TriggerRestApiGwThrottlingTest_2020-09-21" execution in status "Success"
      | ExecutionId                |
      | {{cache:SsmExecutionId>1}} |
  ...
  Scenario: Execute SSM automation document Digito-TriggerRestApiGwThrottlingTest_2020-09-21 with stage name provided
    Given the cloud formation templates as integration test resources
      | CfnTemplatePath                                                                             | ResourceType |
      | resource_manager/cloud_formation_templates/RestApiGwTemplate.yml                            | ON_DEMAND    |
      | documents/api-gw/test/throttling-rest/2020-09-21/Documents/AutomationAssumeRoleTemplate.yml | ASSUME_ROLE  |
