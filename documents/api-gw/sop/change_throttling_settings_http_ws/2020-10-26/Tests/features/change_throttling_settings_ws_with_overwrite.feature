...
Feature: SSM automation document to change HTTP or WS API GW route throttling settings
  ...
  Scenario: Change throttling settings for WS API Gateway with no throttling, ForceExecution=True and with the specified route key
    ...
    When SSM automation document "Digito-ChangeHttpWsApiGwThrottlingSettingsSOP_2020-10-26" executed
      ...
      | {{cfn-output:HTTPWSApiGwTemplate>WsApiGwId}} | {{cfn-output:HTTPWSApiGwTemplate>WsStageName}} | {{cache:before>ExpectedRateLimit}} | {{cache:before>ExpectedBurstLimit}} | $default       | true           | {{cfn-output:AutomationAssumeRoleTemplate>DigitoChangeHttpWsApiGwThrottlingSettingsSOPAssumeRole}} |
  ...
  Scenario: Change throttling settings for WS API Gateway with throttling enabled, ForceExecution=True and with the specified route key
    ...
    When SSM automation document "Digito-ChangeHttpWsApiGwThrottlingSettingsSOP_2020-10-26" executed
      | HttpWsApiGwId                                | HttpWsStageName                                         | HttpWsThrottlingRate               | HttpWsThrottlingBurst               | HttpWsRouteKey | ForceExecution | AutomationAssumeRole                                                                               |
      | {{cfn-output:HTTPWSApiGwTemplate>WsApiGwId}} | {{cfn-output:HTTPWSApiGwTemplate>WsStageNameThrottled}} | {{cache:before>ExpectedRateLimit}} | {{cache:before>ExpectedBurstLimit}} | $default       | true           | {{cfn-output:AutomationAssumeRoleTemplate>DigitoChangeHttpWsApiGwThrottlingSettingsSOPAssumeRole}} |
    Then SSM automation document "Digito-ChangeHttpWsApiGwThrottlingSettingsSOP_2020-10-26" execution in status "Success"
      | ExecutionId                |
      | {{cache:SsmExecutionId>1}} |
    And cache route throttling rate limit as "RateLimit" and burst limit as "BurstLimit" "after" SSM automation execution
  ...
  Scenario: Fail to change rate limit above account quota for WS API Gateway with throttling enabled, ForceExecution=True and with the specified route key
    ...
    When SSM automation document "Digito-ChangeHttpWsApiGwThrottlingSettingsSOP_2020-10-26" executed
      | HttpWsApiGwId                                | HttpWsStageName                                         | HttpWsThrottlingRate | HttpWsThrottlingBurst               | HttpWsRouteKey | ForceExecution | AutomationAssumeRole                                                                               |
      | {{cfn-output:HTTPWSApiGwTemplate>WsApiGwId}} | {{cfn-output:HTTPWSApiGwTemplate>WsStageNameThrottled}} | 20000                | {{cache:before>ExpectedBurstLimit}} | $default       | true           | {{cfn-output:AutomationAssumeRoleTemplate>DigitoChangeHttpWsApiGwThrottlingSettingsSOPAssumeRole}} |
  ...
  Scenario: Fail to change burst limit above account quota for WS API Gateway with throttling enabled, ForceExecution=True and with the specified route key
    ...
    When SSM automation document "Digito-ChangeHttpWsApiGwThrottlingSettingsSOP_2020-10-26" executed
      | HttpWsApiGwId                                | HttpWsStageName                                         | HttpWsThrottlingRate               | HttpWsThrottlingBurst | HttpWsRouteKey | ForceExecution | AutomationAssumeRole                                                                               |
      | {{cfn-output:HTTPWSApiGwTemplate>WsApiGwId}} | {{cfn-output:HTTPWSApiGwTemplate>WsStageNameThrottled}} | {{cache:before>ExpectedRateLimit}} | 10000                 | $default       | true           | {{cfn-output:AutomationAssumeRoleTemplate>DigitoChangeHttpWsApiGwThrottlingSettingsSOPAssumeRole}} |
    Then SSM automation document "Digito-ChangeHttpWsApiGwThrottlingSettingsSOP_2020-10-26" execution in status "Failed"
      | ExecutionId                |
      | {{cache:SsmExecutionId>1}} |
    And cache route throttling rate limit as "RateLimit" and burst limit as "BurstLimit" "after" SSM automation execution
