...
Feature: SSM automation document Digito-UpdateKinesisDataStreamsShardCountSOP_2020-10-26

  Scenario: Execute Digito-UpdateKinesisDataStreamsShardCountSOP_2020-10-26 two times to increase the number of shards and decrease back
    # DEDICATED is set to handle the error occurred (LimitExceededException) when calling the UpdateShardCount operation (reached max retries: 4)
    ...
    And published "Digito-UpdateKinesisDataStreamsShardCountSOP_2020-10-26" SSM document
    ...
    When SSM automation document "Digito-UpdateKinesisDataStreamsShardCountSOP_2020-10-26" executed
      | StreamName                                             | AutomationAssumeRole                                                                              | TargetShardCount                               |
      | {{cfn-output:KinesisDataStream>KinesisDataStreamName}} | {{cfn-output:AutomationAssumeRoleTemplate>DigitoUpdateKinesisDataStreamsShardCountSOPAssumeRole}} | {{cache:before_increasing>ExpectedShardCount}} |

    Then SSM automation document "Digito-UpdateKinesisDataStreamsShardCountSOP_2020-10-26" execution in status "Success"
      | ExecutionId                |
    ...
    When SSM automation document "Digito-UpdateKinesisDataStreamsShardCountSOP_2020-10-26" executed
      | StreamName                                             | AutomationAssumeRole                                                                              | TargetShardCount                               |
      | {{cfn-output:KinesisDataStream>KinesisDataStreamName}} | {{cfn-output:AutomationAssumeRoleTemplate>DigitoUpdateKinesisDataStreamsShardCountSOPAssumeRole}} | {{cache:before_decreasing>ExpectedShardCount}} |
  ...
  Scenario: Execute Digito-UpdateKinesisDataStreamsShardCountSOP_2020-10-26 to pass the same number of shards as it was before
    # DEDICATED is set to handle the error occurred (LimitExceededException) when calling the UpdateShardCount operation (reached max retries: 4)
    Given the cloud formation templates as integration test resources
      | CfnTemplatePath                                                                                             | ResourceType | KmsKey                              |
      | resource_manager/cloud_formation_templates/shared/KMS.yml                                                   | SHARED       |                                     |
    ...
    When SSM automation document "Digito-UpdateKinesisDataStreamsShardCountSOP_2020-10-26" executed
      | StreamName                                             | AutomationAssumeRole                                                                              | TargetShardCount               |
      | {{cfn-output:KinesisDataStream>KinesisDataStreamName}} | {{cfn-output:AutomationAssumeRoleTemplate>DigitoUpdateKinesisDataStreamsShardCountSOPAssumeRole}} | {{cache:before>OldShardCount}} |
