...
Feature: SSM automation document Digito-DecreaseNumberOfShards_2020-09-21
  ...
  Scenario: Execute SSM automation document Digito-DecreaseNumberOfShards_2020-09-21 in rollback
    ...
    And Wait for the SSM automation document "Digito-DecreaseNumberOfShards_2020-09-21" execution is on step "AssertAlarmToBeRed" in status "InProgress"
      | ExecutionId                |
      | {{cache:SsmExecutionId>1}} |
    And terminate "Digito-DecreaseNumberOfShards_2020-09-21" SSM automation document
      | ExecutionId                |
      | {{cache:SsmExecutionId>1}} |

    Then Wait for the SSM automation document "Digito-DecreaseNumberOfShards_2020-09-21" execution is on step "TriggerRollback" in status "Success"
      | ExecutionId                |
      | {{cache:SsmExecutionId>1}} |
    And SSM automation document "Digito-DecreaseNumberOfShards_2020-09-21" execution in status "Cancelled"
      | ExecutionId                |
      | {{cache:SsmExecutionId>1}} |
