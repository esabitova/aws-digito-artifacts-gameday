...
1. `CleanS3BucketWhereObjectsWillBeDeletedFrom`
    * Type: aws:executeAutomation
    * Inputs:
        * `DocumentName`: `Digito-CleanS3BucketUtil_2020-03-03`
        * `RuntimeParameters`:
            * `AutomationAssumeRole`: {{AutomationAssumeRole}}
            * `S3BucketNameToClean`: {{S3BucketWhereObjectsWillBeDeletedFrom}}
    * Explanation:
        * Clean the `S3BucketWhereObjectsWillBeDeletedFrom` bucket by calling shared SSM document  `Digito-CleanS3BucketUtil_2020-03-03`
