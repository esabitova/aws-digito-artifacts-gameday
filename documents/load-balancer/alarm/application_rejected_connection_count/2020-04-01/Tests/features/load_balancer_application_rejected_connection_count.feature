...
Feature: Alarm Setup - load-balancer RejectedConnectionCount
  ...
  Scenario: Create load-balancer:alarm:application_rejected_connection_count:2020-04-01 based on RejectedConnectionCount metric and check OK status
    ...
    When alarm "load-balancer:alarm:application_rejected_connection_count:2020-04-01" is installed
