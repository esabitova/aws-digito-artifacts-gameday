...
Feature: Alarm Setup - load-balancer LambdaInternalError
  ...
  Scenario: Create load-balancer:alarm:application_lambda_internal_error:2020-04-01 based on LambdaInternalError metric and check OK status
    ...
    When alarm "load-balancer:alarm:application_lambda_internal_error:2020-04-01" is installed
