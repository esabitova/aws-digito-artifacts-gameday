...
Feature: SSM automation document Digito-ForceNetworkGwLbTargetUnavailableTest_2020-04-01
  ...
  Scenario: Create Network LB and execute automation to make the target group unavailable
    Given the cloud formation templates as integration test resources
      ...
      | documents/load-balancer/test/network_gw_lb_target_unavailable/2020-04-01/Documents/AutomationAssumeRoleTemplate.yml | ASSUME_ROLE  |                          |                                   |                             |
      | resource_manager/cloud_formation_templates/shared/SnsForAlarms.yml                                        | SHARED       |                          |                                   |                             |
    And published "Digito-ForceNetworkGwLbTargetUnavailableTest_2020-04-01" SSM document
    And alarm "load-balancer:alarm:network_unhealthy_host_count:2020-04-01" is installed
    ...
    When SSM automation document "Digito-ForceNetworkGwLbTargetUnavailableTest_2020-04-01" executed
      ...
      | {{cfn-output:NetworkLoadBalancerTemplate>NetworkELBArn}} | {{alarm:under_test>AlarmName}} | {{cfn-output:AutomationAssumeRoleTemplate>DigitoForceNetworkGwLbTargetUnavailableTestAssumeRole}} |

    Then SSM automation document "Digito-ForceNetworkGwLbTargetUnavailableTest_2020-04-01" execution in status "Success"
      | ExecutionId                |
  ...
  Scenario: Create Network LB and execute automation to make the target group unavailable with target groups specified
    ...
    When SSM automation document "Digito-ForceNetworkGwLbTargetUnavailableTest_2020-04-01" executed
      ...
      | {{cfn-output:NetworkLoadBalancerTemplate>NetworkELBArn}} | {{cfn-output:NetworkLoadBalancerTemplate>TargetGroup}} | {{alarm:under_test>AlarmName}} | {{cfn-output:AutomationAssumeRoleTemplate>DigitoForceNetworkGwLbTargetUnavailableTestAssumeRole}} |
  ...
  Scenario: Create Gateway LB and execute automation to make the target group unavailable
    Given the cloud formation templates as integration test resources
      ...
      | resource_manager/cloud_formation_templates/shared/SnsForAlarms.yml                                        | SHARED       |                          |                                   |                             |
    And published "Digito-ForceNetworkGwLbTargetUnavailableTest_2020-04-01" SSM document
    And alarm "load-balancer:alarm:gateway_unhealthy_host_count:2020-04-01" is installed
    ...
    When SSM automation document "Digito-ForceNetworkGwLbTargetUnavailableTest_2020-04-01" executed
      | LoadBalancerArn                                          | SyntheticAlarmName             |  AutomationAssumeRole                                                                             |
      | {{cfn-output:GatewayLoadBalancerTemplate>GatewayELBArn}} | {{alarm:under_test>AlarmName}} | {{cfn-output:AutomationAssumeRoleTemplate>DigitoForceNetworkGwLbTargetUnavailableTestAssumeRole}} |
  ...
  Scenario: Create Gateway LB and execute automation to make the target group unavailable with target groups specified
    ...
    When SSM automation document "Digito-ForceNetworkGwLbTargetUnavailableTest_2020-04-01" executed
      | LoadBalancerArn                                          | TargetGroupArns                                        | SyntheticAlarmName             |  AutomationAssumeRole                                                                             |
      | {{cfn-output:GatewayLoadBalancerTemplate>GatewayELBArn}} | {{cfn-output:GatewayLoadBalancerTemplate>TargetGroup}} | {{alarm:under_test>AlarmName}} | {{cfn-output:AutomationAssumeRoleTemplate>DigitoForceNetworkGwLbTargetUnavailableTestAssumeRole}} |
