...
def cache_recovery_point_arn(resource_pool, boto3_session, ssm_test_cache,
    ...
    iam_role_arn = extract_param_value(input_parameters, 'BackupRoleArn', resource_pool, ssm_test_cache)
...
def teardown_backup_vault(resource_pool, boto3_session, ssm_test_cache, input_parameters):
    backup_vault_arn = extract_param_value(input_parameters, 'BackupVaultArn', resource_pool, ssm_test_cache)
    region = extract_param_value(input_parameters, 'RegionName', resource_pool, ssm_test_cache)
    backup_vault_name = backup_vault_arn.split(':')[-1]
...
def teardown_fs_by_arn(resource_pool, boto3_session, ssm_test_cache, input_parameters):
    region = None
    try:
        region = extract_param_value(input_parameters, 'RegionName', resource_pool, ssm_test_cache)
    except KeyError:
        pass
    fs_arn = extract_param_value(input_parameters, 'FileSystemARN', resource_pool, ssm_test_cache)
