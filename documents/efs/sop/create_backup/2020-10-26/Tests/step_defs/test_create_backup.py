...
def assert_recovery_point_exists_and_correct(resource_pool, boto3_session, ssm_test_cache, input_parameters):
    ...
    fs_id = extract_param_value(input_parameters, 'FileSystemId', resource_pool, ssm_test_cache)
