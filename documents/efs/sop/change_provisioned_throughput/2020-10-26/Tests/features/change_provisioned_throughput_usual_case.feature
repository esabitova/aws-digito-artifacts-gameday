@efs
Feature: SSM automation document Digito-ChangeEFSProvisionedThroughputSOP_2020-10-26

  Scenario: Execute SSM automation document Digito-ChangeEFSProvisionedThroughputSOP_2020-10-26
    ...
    And published "Digito-ChangeEFSProvisionedThroughputSOP_2020-10-26" SSM document
    ...
    When SSM automation document "Digito-ChangeEFSProvisionedThroughputSOP_2020-10-26" executed
      | FileSystemID                     | ProvisionedThroughput                          | AutomationAssumeRole                                                                           |
      | {{cfn-output:EFSTemplate>EFSID}} | {{cache:before>ExpectedProvisionedThroughput}} | {{cfn-output:AutomationAssumeRoleTemplate>DigitoChangeEFSProvisionedThroughputSOPAssumeRole}}  |

    Then SSM automation document "Digito-ChangeEFSProvisionedThroughputSOP_2020-10-26" execution in status "Success"
      | ExecutionId                |
