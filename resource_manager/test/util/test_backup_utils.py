...
from documents.util.scripts.test.test_backup_util import \
    list_efs_recovery_points_by_backup_vault, \
    list_empty_recovery_points, \
...
class TestBackupUtil(unittest.TestCase):
    ...
    def test_get_recovery_point(self):
        ...
        self.mock_backup_service.\
            ...
            return_value = list_efs_recovery_points_by_backup_vault(backup_vault_name)
    ...
    def test_get_recovery_points(self):
        ...
        self.mock_backup_service.list_recovery_points_by_backup_vault. \
            assert_called_once_with(BackupVaultName=backup_vault_name)
        self.assertEqual(result, list_efs_recovery_points_by_backup_vault(backup_vault_name)['RecoveryPoints'])

    def test_get_recovery_points_with_wrong_resource_arn(self):
        backup_vault_name = BACKUP_VAULT_NAME
        self.mock_backup_service. \
            list_recovery_points_by_backup_vault. \
            return_value = list_empty_recovery_points()
