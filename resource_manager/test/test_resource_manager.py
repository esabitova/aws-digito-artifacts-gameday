...
class TestResourceManager(unittest.TestCase):
    ...
    def test_pull_resources_by_template_name_missing_template_index_success(self, create_mock, query_mock):
        ...
        self.rm.add_cfn_template(self.test_template_name, ResourceManager.ResourceType.ON_DEMAND, test_param='test_param_value')
        resource = self.rm.pull_resource_by_template(self.test_template_name, 2, ResourceManager.ResourceType.ON_DEMAND, 5)
    ...
    def test_pull_resources_success(self, query_mock):
        ...
        self.rm.add_cfn_template(self.test_template_name, ResourceManager.ResourceType.ON_DEMAND, test_param='test_param_value')
        self.rm.add_cfn_template(self.test_template_name + '_1', ResourceManager.ResourceType.ON_DEMAND, test_param='test_param_value')
